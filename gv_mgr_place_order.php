...
<div class="field" style="'. $box_size_str .'">
	<p class="help">Order Number:</p>
	<div class="control">
		<input id="id_order_number" class="input is-normal" type="text" placeholder="TS728345" value="" name="id_order_number" required>
	</div>
</div>
...
<div class="field" style="'. $box_size_str .'">
	<p class="help">Customer:</p>
	<div class="control">
		<input id="id_customer_code" class="input is-normal" type="text" placeholder="D077" value="B007" name="id_customer_code" required>
	</div>
</div>
