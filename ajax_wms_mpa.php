	...
	try
	{
		...
		)
		{
			...
			)
			{
				...
				$outcome		=	get_product_data_via_barcode($db, $product_barcode, 0, $user_company_uid);
				...
				if ($message_id == 0)
				{
					...
					$qty_adjust_input	.=	'<div class="field has-addons">';
						...
						$qty_adjust_input	.=	'<input style="text-align: center;" class="input" type="text" id="product_qty" name="product_qty" value="1"' . $input_disabled . '>';
						$qty_adjust_input	.=	'</p>';
