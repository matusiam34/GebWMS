...
<head>
	...
	<script language="javascript" type="text/javascript">
		...
		//	Release the order to go live! It will show on the Pick Order page of the picker (or user with that menu enabled)!
		function allocate_order()
		{


			$.post('ajax_mgr_orders_allocate_order.php', { 
			...
			function(output)
			{
				...
				if (obje.control == 0)
				{
					...
					//	Need to refresh the page to adjust for the changes?
					//	Will have to redesign this to use AJAX
					window.location.href = 'gv_mgr_orders.php';
					//$('#items').empty();
					//$('#items').append(obje.html);
