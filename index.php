	...
	echo	'<div class="container box has-background-light">';
		...
		echo '<div class="columns">';
			...
			echo '<div class="column is-3">';
				...
				{
					$sku_link		=	"location.href='wms_mgr_sku.php'";

					echo	'<div class="field">
								<div class="control">
									<a class="button is-normal is-fullwidth manager_class is-bold" onclick="' . $sku_link . '">' . $mylang['stock_keeping_unit'] . '</a>
								</div>
							</div>';
...
/*
				if (is_it_enabled($_SESSION['menu_mgr_product_sku']))
				{
					$sku_link		=	"location.href='wms_mgr_product_sku.php'";
...
*/
			...
			echo '<div class="column is-3">';
				...
				{
					$my_account_link		=	"location.href='geb_my_account.php'";
				...
				if	($user_company_uid == 0)
				{
					...
					{
						$company_link		=	"location.href='geb_companies.php'";
				...
				{
					$warehouse_locations_link		=	"location.href='wms_adm_locations.php'";
				...
				{
					$package_units_link		=	"location.href='wms_adm_package_unit.php'";

					echo	'<div class="field">
								<div class="control">
									<a class="button is-normal is-fullwidth admin_class is-bold" onclick="' . $package_units_link . '">' . $mylang['package_unit'] . '</a>
								</div>
							</div>';
				}
				...
				{
					$users_link		=	"location.href='geb_users.php'";
				...
				{
					$category_link		=	"location.href='wms_adm_categories.php'";
